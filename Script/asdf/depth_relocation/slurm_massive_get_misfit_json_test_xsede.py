...
sync_dir = "/scratch/05880/tg851791/relocation/work/asdf_processed_test"
log_file = "/scratch/05880/tg851791/relocation/work/misfit_test.log"
json_dir = "/scratch/05880/tg851791/relocation/work/misfit_json_test"
...
def submit_job(thecommand):
    s = Slurm("process", {"nodes": 2, "ntasks": 96,
                          "partition": 'skx-normal', "time": "01:00:00", "account": "TG-EAR130011"})
    s.run(thecommand)
