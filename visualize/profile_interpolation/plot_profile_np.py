...
def main(region, rawregion, data, parameter, npts):
    ...
    x_mesh, y_mesh, z_mesh = prepare_mesh(
    ...
    if(plot_vertically):
        ...
        if(lat_diff > lon_diff):
            ...
            plot_on = "longitude"
        plt.contour(mesh_plot_h, mesh_plot_v, plot_values,
                    resolution, cmap=plt.cm.seismic_r)
